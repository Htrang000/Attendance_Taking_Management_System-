...
<body>
    ...
    <div class="logout">
        <span class="material-symbols-outlined">
            logout <span id="logout"> <a href="login.html" style="color: #f27024;">log out</a></span>
        </span>
    </div>
    ...
    <div class="option">
        <button type="button" class="option1-button">Weekly timetable</button>
        <button type="button" class="option2-button">Attendance Report</button> <br>
        <button type="button" class="option3-button">Student Information</button>
        <button type="button" class="option4-button">Help</button> <br>
    </div>
